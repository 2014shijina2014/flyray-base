...
insert  into `qrtz_scheduler_state`(`SCHED_NAME`,`INSTANCE_NAME`,`LAST_CHECKIN_TIME`,`CHECKIN_INTERVAL`) values ('RenrenScheduler','DESKTOP-SBB24811508417629906',1508418190340,15000);
...
insert  into `sys_org`(`id`,`org_no`,`name`,`parent_id`,`create_by`,`create_time`,`last_update_by`,`last_update_time`,`org_sort`,`status_flag`) values (1,'2','飞雷集团',0,NULL,'2017-07-08 16:28:20',NULL,'2017-04-05 22:43:10',233,0),(2,'admin','技术部',1,NULL,'2017-09-16 16:14:31',NULL,'2017-04-05 22:43:10',2233,0);
...
CREATE TABLE `sys_user` (
  ...
  `create_user_id` bigint(20) DEFAULT NULL COMMENT '创建者ID',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `org_id` bigint(20) DEFAULT NULL COMMENT '所属部门机构',
